...
class ProductStateNotifier extends StateNotifier<List<ProductModel>> {
  ...
  List<ProductModel> getItems() {
    final products = {
      '스쿼트 렉 + 무게 30 * 4 + 깔판0': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판1': 10200,
      ...
      '스쿼트 렉 + 무게 30 * 4 + 깔판9': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판10': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판11': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판12': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판13': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판14': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판15': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판16': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판17': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판18': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판19': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판20': 10200,
      '스쿼트 렉 + 무게 30 * 4 + 깔판21': 10200,
    };
